...
<head>
	<meta charset="utf-8" />
	<title>Fund Status | Report</title>
...
<body data-gr-c-s-loaded="true">
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="active"><a href="fo-fund.php"><i class="fas fa-money-bill-alt"></i> <span>Fund Status Report</span></a></li>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Fund Inquiry</h1>
			<!-- end page-header -->
			...
			<div class="row">
			    <!-- begin col-2 -->
			    <div class="col-lg-2">
			        <h5>The Fund Inquiry does the following features:</h5>
                    <ul class="p-l-25 m-b-15">
                        <li>Display Fund details</li>
                        <li>View Total Fund</li>
                        <li>Filter Table</li>
                        <li>Print Report</li>
			    ...
			    <div class="col-lg-10">
                    <div class="panel panel-inverse">
                        ...
                        <!-- end panel-heading -->
                        <!-- begin panel-body -->
                        <?php $tablesql = "SELECT  sum(((B.prod_poamount - (D.prod_machinecost + D.prod_materialcost)) -  ROUND(( B.prod_poamount - (D.prod_machinecost + D.prod_materialcost))*(A.stkh_percent/100),2)) * .2) AS SUMOF
                        ...
                        <div class="invoice-price-left">
                            <div class="invoice-price-row">
                                <div class="sub-price">
                                    <small>SUM OF CONTIGENT FUNDS</small>
                        ...
                        <div class="invoice-price-right">
                            <small>TOTAL</small> <span class="f-w-600">PHP <?php echo $sumfund; ?></span>
                        </div>
                    </div>
                    <br/>
                            ...
                            <table id="data-table-combine" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                       ...
                                       <td><?php echo $fund; ?></td>
                                       <td><button class="btn btn-lime "><i class='fas fa-print'></i></button></td>
                                   </tr>
								...
								<div class="modal-dialog">
                                        ...
                                        <option value="" disabled selected="">Link User Account</option>
                                          <?php 
                                            $selectacctype = "SELECT a.fname, a.mname, a.lname, a.useraccountID from jamfms_r_useraccount as a 
																inner join jamsfms_r_stakeholder as b
																on b.fk_user_id = a.useraccountID
																inner join jamsfms_r_stakeholder_type as c
																on b.fk_st_type_id = c.st_type_id
																where c.st_type_name = 'Investor'";
                                  ...
                                  <div class="form-group">
                                    <label>Project/PO Number</label>
                                        <select class="form-control" name="userrole" id="getselpo">
	...
	<script type="text/javascript">
        $('#submit').click(function(e){
            ...
            if (get2 == "")
            {
                if (document.getElementById('getselpo').options[f.selectedIndex].value == '')
                {
                    document.getElementById('getselpo').options[0].innerText = "Please select";
                    document.getElementById('getselpo').focus();
                    document.getElementById('getselpo').style.borderColor = "#B94A48";
                    document.getElementById('getselpo').style.color = "#B94A48";
                }
