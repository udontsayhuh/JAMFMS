            ...
            <div class="login-content">
                ...
                <form action="" method="POST" class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input type="text" id="username" name="username" class="form-control form-control-lg inverse-mode" placeholder="Username" required />
                    </div>
                    <div class="form-group m-b-20">
                    ...
                    <div class="login-buttons">
                        <button type="submit" name="loginb" id="loginb" class="btn btn-success btn-block btn-lg">Sign me in</button>
                    </div>
                </form>
            </div>
            <!-- end login-content -->
