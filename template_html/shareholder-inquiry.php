...
<body data-gr-c-s-loaded="true">
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li><a href="shareholder-dashboard.php"><i class="fas fa-chart-bar"></i> <span>Dashboard</span></a></li>
					<li class="active"><a href="shareholder-inquiry.php"><i class="fas fa-money-bill-alt"></i> <span>Shareholder Inquiry</span></a></li>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Shareholder Inquiry Page</h1>
			<!-- end page-header -->
			<?php 

				$selectinv = "SELECT c.companyname as cname, B.prod_poamount - (D.prod_machinecost + D.prod_materialcost) AS NET_INCOME,  ROUND(( B.prod_poamount - (D.prod_machinecost + D.prod_materialcost))*(A.stkh_percent/100),0) as INVESTMENT, ((B.prod_poamount - (D.prod_machinecost + D.prod_materialcost)) -  ROUND(( B.prod_poamount - (D.prod_machinecost + D.prod_materialcost))*(A.stkh_percent/100),0)) * .2 AS FUND, ( B.prod_poamount - (D.prod_machinecost + D.prod_materialcost))-(ROUND(( B.prod_poamount - (D.prod_machinecost + D.prod_materialcost))*(A.stkh_percent/100),0))-(((B.prod_poamount - (D.prod_machinecost + D.prod_materialcost)) -  ROUND(( B.prod_poamount - (D.prod_machinecost + D.prod_materialcost))*(A.stkh_percent/100),0)) * .2) as SHAREHOLDERAMT FROM jamsfms_r_stakeholder AS A
                        ...
                        <div class="invoice-price-left">
                            <div class="invoice-price-row">
                                <div class="sub-price">
                                    ...
                                    <span class="text-inverse">PHP <?php echo $net; ?></span>
                                </div>
                                <div class="sub-price">
                                    <i class="fa fa-times text-muted"></i>
                                </div>
                                <div class="sub-price">
                                    <small>INVESTMENT + CONTIGENT FUND</small>
                                    <span class="text-inverse">PHP <?php echo $invest.' + '.$fund; ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="invoice-price-right">
                            <small>TOTAL</small> <span class="f-w-600">PHP <?php echo $amount; ?></span>
                        </div>
                    </div>
                	<!-- end invoice-price -->
                </div>
