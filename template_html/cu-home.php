		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li><a href="cu-home.php"><i class="fas fa-question-home"></i> <span>Home</span></a></li>
					<li class="active"><a href="cu-inquiry.php"><i class="fas fa-users"></i> <span>PO Inquiry</span></a></li>
