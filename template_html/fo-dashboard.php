			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="widget widget-stats bg-red">
						...
						<div class="stats-info">
							<?php $selectcount = "SELECT COUNT(stkhid) as count, (SELECT count(fk_st_type_id) from jamsfms_r_stakeholder WHERE fk_st_type_id = 2 or fk_st_type_id = 3) as count1, (SELECT count(fk_st_type_id) from jamsfms_r_stakeholder WHERE fk_st_type_id = 1 or fk_st_type_id = 3 ) as count2, (SELECT count(stkhid) from jamsfms_r_stakeholder WHERE stkh_status = 0) as count3 from jamsfms_r_stakeholder";
				...
				<div class="col-lg-3 col-md-6">
					<div class="widget widget-stats bg-black-lighter">
						...
						<div class="stats-info">
							<h4>NUMBER OF ACTIVE SHAREHOLDERS</h4>
							<p><?php echo $count3?></p>	
						</div>
						<div class="stats-link">
							<a href="javascript:;">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
