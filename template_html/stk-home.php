		...
		<div id="sidebar" class="sidebar">
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li><a href="admin-dashboard.php"><i class="fas fa-question-circle"></i> <span>Dashboard</span></a></li>
					<li class="active"><a href="admin-accountsetup.php"><i class="fas fa-users"></i> <span>Inquiry</span></a></li>
			...
			<div class="row">
			    ...
			    <div class="col-lg-2">
                    ...
                    <ul class="p-l-25 m-b-15">
                        <li>View Purchase Order Inquiry</li>
                        <li>View Account</li>
