...
<body data-gr-c-s-loaded="true">
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
                                   			...
                                   			<div class="modal fade" id="edit<?php echo $ID; ?>">
												...
												<div class="modal-body">
								                                  ...
								                                  <div class="form-group">
								                                    ...
								                                    <input value="<?php echo $usname; ?>" type="text" required class="form-control form-control-sm" name="editlname" id="editusname">
								                                  </div>
								                                  </form>
								                                  <div id="userneym2" style="color: red;"></div>
								                                  <div class="form-group row">
																	<label class="col-md-4 col-form-label">User Role</label>
																	<select class="form-control" name="userrole" id="editgetsel">
								                                        <option value="<?php  echo $acctypeid ?>"" disabled selected=""><?php echo $acctype; ?></option>
								                                          <?php 
																...
																<input type="hidden" id="hid_sel2" value="<?php  echo $acctypeid ?>">
																<input type="hidden" id="hid_sel3">
		...
		<div class="modal fade" id="modal-dialog">
								<div class="modal-dialog">
                                  ...
                                  <form method="POST" id="thisForm" name="form">
                                  <div class="form-group">
                                    <label>Username</label>
                                    <input type="text" required class="form-control form-control-sm" name="u_name" id="u_name">
                                  	
                                  </div>
                                  <div id="userneym" style="color: red;"></div>
                              	</form>
                                  <div class="form-group">
                                    <label>Default Password</label>
                                    <input type="text"  value="password" disabled class="form-control form-control-sm" name="lname" id="defpass">
                                  </div>
                                  <!--<div class="form-group">
                                    <label>Username</label>
    ...
    <script type="text/javascript">
       $('button[id=submit2]').click(function(e){
            ...
            var usnameuser = $('div[id=edit'+id+']').find('input[id=editusname]').val();
            
            var get = $('div[id=edit'+id+']').find('input[id=hid_sel]').val();
            /*if (get == "")
            {
                if ($("select[id='editgetsel']").find("option:selected").index().val() == '')
                {
                    document.getElementById('editgetsel').options[0].innerText = "Please select";
                    document.getElementById('editgetsel').focus();
                    document.getElementById('editgetsel').style.borderColor = "#B94A48";
                    document.getElementById('editgetsel').style.color = "#B94A48";
                }
 ...
 $(document).ready(function(){  
 	$("#userneym").load('INCLUDES/check.php').show();
   $('#u_name').keyup(function(){
   	$.post('INCLUDES/check.php', { username: form.u_name.value },
   		function(result) {
   			$('#userneym').html(result).show();
   			$('#userneym').prop("class", "alert alert-danger fade show");
   			if (result == ""){
   				$('#userneym').prop("style", "display:none;");
   			}
   		});
   /*	$.post('INCLUDES/check.php', { username: form.u_name.value},
   		function(result) {
...
<script type="text/javascript">
 ...
 /*$(document).ready(function(){  
 	$("#userneym2").load('INCLUDES/check.php').show();
   $('#editusname').keyup(function(){
   	$.post('INCLUDES/check.php', { username: form2.editusname.value },
   		function(result) {
   			$('#userneym2').html(result).show();
   			$('#userneym2').prop("class", "alert alert-danger fade show");
   			if (result == ""){
   				$('#userneym2').prop("style", "display:none;");
   			}
   		});
   /*	$.post('INCLUDES/check.php', { username: form.u_name.value},
   		function(result) {
...
/* });
  ...
  <script type="text/javascript">
  	$("select[id='editgetsel']").focusout(function() {
     var selected = $(this).find("option:selected").index();
     var selected = selected +1;
     $("input[id='hid_sel']").val(selected);
     if (selected == "0") 
          $("input[name='hid_sel3']").attr("value", "1");
     /*
     else
