<?php 
	...
	$updatequery = "UPDATE `jamsfms_r_sales` SET `fk_prod_id`= '$insert_prod',`customer_code`='$insert_cust',`po_num`=$insert_so,`so_qty`=$insert_qty, deldate = '$insert_ddate' WHERE so_id = $aydi";
